...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' https://js.stripe.com https://www.googletagmanager.com https://www.google-analytics.com https://www.googleadservices.com https://connect.facebook.net",
...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/author/:path*", destination: "/lafropeen", permanent: true },
      { source: "/tag/:path*", destination: "/lafropeen", permanent: true },
      { source: "/category/:path*", destination: "/lafropeen", permanent: true },
      { source: "/archives/:path*", destination: "/lafropeen", permanent: true },
      { source: "/.well-known/:path*", destination: "/", permanent: true },
      { source: "/my-account/:path*", destination: "/auth/signin", permanent: true },
      { source: "/mon-compte/:path*", destination: "/auth/signin", permanent: true },
      { source: "/panier/:path*", destination: "/saison-culturelle-africaine", permanent: true },
      { source: "/cart/:path*", destination: "/saison-culturelle-africaine", permanent: true },
      { source: "/checkout/:path*", destination: "/saison-culturelle-africaine", permanent: true },
      { source: "/produit/:path*", destination: "/saison-culturelle-africaine", permanent: true },
      { source: "/product/:path*", destination: "/saison-culturelle-africaine", permanent: true },
      { source: "/elementor/:path*", destination: "/", permanent: true },
      { source: "/sample-page/:path*", destination: "/", permanent: true },
      { source: "/favicon.ico", destination: "/favicon.ico", permanent: false },
    ];
  },
};
