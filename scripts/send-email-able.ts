...
<body style="font-family: Georgia, serif; color: #1a1a1a; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <p>Bonjour <strong>Madame Gbalé</strong>,</p>

  <p>Merci pour votre intérêt pour la Foire d'Afrique Paris - 6ème Édition ! Vos textiles traditionnels africains seraient un bel atout pour l'événement.</p>

  <p>Voici toutes les informations demandées :</p>
  ...
  <ul>
    <li>Acompte de 50 € pour confirmer votre place</li>
...
async function main() {
  ...
  if (error) {
    ...
    console.log("OK - Email envoyé à info@warafany.com");
  }
}
