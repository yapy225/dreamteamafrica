...
<body style="font-family: Georgia, serif; color: #1a1a1a; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <p>Bonjour <strong>Kefil</strong>,</p>

  <p>Votre espace exposant est prêt. Voici vos identifiants de connexion :</p>
  ...
  <div style="background: #FBF8F2; border-radius: 12px; padding: 20px; margin: 24px 0;">
    <table style="width: 100%; border-collapse: collapse;">
      <tr>
        ...
        <td style="padding: 6px 0; font-size: 14px; font-weight: 600; color: #1a1a1a;">houssoukefil@gmail.com</td>
      </tr>
      <tr>
        <td style="padding: 6px 0; font-size: 13px; color: #888;">Mot de passe temporaire</td>
        <td style="padding: 6px 0; font-size: 14px; font-weight: 600; color: #1a1a1a;">1dab7374</td>
      </tr>
    </table>
  </div>

  <p><strong>Pour vous connecter et choisir votre stand :</strong></p>
  <ol>
    <li>Rendez-vous sur <a href="https://dreamteamafrica.com/connexion" style="color: #8B6F4E;">dreamteamafrica.com/connexion</a></li>
    <li>Connectez-vous avec les identifiants ci-dessus</li>
    <li>Accédez à votre espace exposant</li>
    <li>Consultez le plan de salle et sélectionnez l'emplacement de votre choix</li>
    <li>Pensez à modifier votre mot de passe dans vos paramètres</li>
  </ol>
...
async function main() {
  ...
  if (error) {
    ...
    console.log("OK - Email envoyé à houssoukefil@gmail.com");
  }
}
