...
<body style="font-family: Georgia, serif; color: #1a1a1a; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <p>Bonjour <strong>Madame Matondo</strong>,</p>

  <p>Merci pour votre intérêt pour la Foire d'Afrique Paris - 6ème Édition ! Nous serions ravis de vous accueillir pour la promotion de votre livre.</p>
...
async function main() {
  ...
  if (error) {
    ...
    console.log("OK - Email envoyé à martinematondo57@gmail.com");
  }
}
