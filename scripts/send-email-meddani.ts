...
<body style="font-family: Georgia, serif; color: #1a1a1a; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <p>Bonjour <strong>Med Dani</strong>,</p>

  <p>Merci pour votre candidature et pour la présentation détaillée de votre parcours artistique. Votre profil afro-acoustique World et votre expérience avec la kora sont très intéressants.</p>

  <p>Nous avons bien enregistré votre fiche artiste. Afin de la compléter avec toutes les informations nécessaires, nous vous invitons à remplir le formulaire suivant :</p>
...
async function main() {
  const { error } = await resend.emails.send({
    ...
    to: "musiquemandingue.keita17@gmail.com",
  ...
  if (error) {
    ...
    console.log("OK - Email envoyé à musiquemandingue.keita17@gmail.com");
  }
}
