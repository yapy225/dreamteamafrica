...
<body style="font-family: Georgia, serif; color: #1a1a1a; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <p>Bonjour <strong>Souleymane</strong>,</p>
  ...
  <p>Concernant votre frère à Bamako, il est tout à fait possible de réserver un stand pour lui également. Vous pouvez gérer la réservation pour les deux si besoin.</p>
...
async function main() {
  ...
  if (error) {
    ...
    console.log("OK - Email envoyé à 1980barryaischa@gmail.com");
  }
}
