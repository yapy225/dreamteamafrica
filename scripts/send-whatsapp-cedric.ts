...
const message = `Bonjour Cedric,

Merci pour votre interet pour la Foire d'Afrique Paris - 6eme Edition !

Voici nos offres exposant pour Defintek :
...
*Pack Restauration 2 jours - 1 000 EUR* (500 EUR/jour)
- 2 tables
- 4 chaises
- 4 badges exposants
- Espace restauration dedie
...
async function main() {
  try {
    await sendWhatsAppText("+23674569696", message);
    console.log("OK - WhatsApp envoye a +23674569696");
  } catch (err) {
