...
const message = `Bonjour Cira,

Nous avons bien note votre demande d'informations complementaires.

Pour rappel, voici nos offres exposant :
...
Pour toute question supplementaire, vous pouvez contacter notre presidente Yvylee Koffi au *+33 7 43 53 75 51*.
...
async function main() {
  try {
    await sendWhatsAppText("+33768366395", message);
    console.log("OK - WhatsApp envoye a +33768366395");
  } catch (err) {
