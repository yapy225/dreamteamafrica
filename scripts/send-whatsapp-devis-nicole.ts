...
const message = `Bonjour Nicole,

Merci pour votre interet pour la Foire d'Afrique Paris - 6eme Edition !

Voici notre offre exposant pour La Dame Chiic :
...
async function main() {
  try {
    await sendWhatsAppText("+33610690118", message);
    console.log("OK - WhatsApp envoye a +33610690118 (Nicole Tiangaye - La Dame Chiic)");
  } catch (err) {
