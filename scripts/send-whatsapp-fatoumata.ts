...
const message = `Bonjour Fatoumata,

Merci pour votre interet pour la Foire d'Afrique Paris - 6eme Edition !

Voici nos offres exposant pour Kania Fashion :
...
async function main() {
  try {
    await sendWhatsAppText("+33665056622", message);
    console.log("OK - WhatsApp envoye a +33665056622");
  } catch (err) {
