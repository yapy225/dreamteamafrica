...
Oui, le stand est un espace ouvert (decouvert). Vous pouvez choisir 1 ou 2 jours selon votre preference.
...
async function main() {
  try {
    await sendWhatsAppText("+33765646827", message);
    console.log("OK - WhatsApp envoye a +33765646827");
  } catch (err) {
