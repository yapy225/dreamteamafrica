...
Si vous rencontrez toujours des difficultes pour reserver, n'hesitez pas a nous indiquer le probleme et nous vous aiderons.

L'equipe Dream Team Africa`;

async function main() {
  try {
    await sendWhatsAppText("+33777044376", message);
    console.log("OK - WhatsApp envoye a +33777044376");
  } catch (err) {
