...
const message = `Bonjour Victoria,

Merci pour votre interet pour la Foire d'Afrique Paris - 6eme Edition !

Voici nos offres exposant pour Emefanaturals :
...
async function main() {
  try {
    await sendWhatsAppText("+33636683304", message);
    console.log("OK - WhatsApp envoye a +33636683304");
  } catch (err) {
