...
*Concernant le visa :*
Une fois votre acompte verse, nous vous fournirons une lettre d'invitation officielle de l'association Dream Team pour appuyer votre demande de visa aupres du consulat de France au Burkina Faso.
...
async function main() {
  try {
    await sendWhatsAppText("+22668680198", message);
    console.log("OK - WhatsApp envoye a +22668680198");
  } catch (err) {
