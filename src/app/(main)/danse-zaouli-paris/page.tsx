...
export const metadata: Metadata = {
  ...
  description:
    "Cours de danse Zaouli et danse africaine traditionnelle à Paris. Stage, initiation, cours débutant avec percussions live. Spectacles pour mariages, comités d'entreprise, festivals. Danse UNESCO de Côte d'Ivoire. Dream Team Africa.",
  keywords: [
    // ── Zaouli spécifique
    "danse zaouli paris",
    "cours danse zaouli",
    ...
    "zaouli UNESCO",
    "apprendre le zaouli",
    "danse zaouli mariage",
    // ── Cours de danse africaine
    "cours danse africaine paris",
    "cours danse traditionnelle africaine paris",
    "cours danse africaine débutant paris",
    "cours danse africaine ile de france",
    "stage danse africaine paris",
    "atelier danse africaine paris",
    "initiation danse africaine paris",
    "école danse africaine paris",
    "danse africaine percussions live paris",
    // ── Spectacles & événementiel
    "spectacle danse africaine",
    "spectacle danse africaine paris",
    "troupe danse africaine paris",
    "danse africaine mariage",
    "animation danse africaine mariage",
    "animation africaine comité entreprise",
    "team building danse africaine",
    "animation danse africaine soirée",
    "spectacle africain comité entreprise",
    "danseurs africains événement",
    "troupe danse africaine événement",
    // ── Danse traditionnelle
    "danse traditionnelle africaine paris",
    "danse traditionnelle côte d'ivoire",
    "danse gouro",
    "danse masque africain",
    "danse africaine avec percussions",
    "danse africaine djembé",
    // ── Longue traîne locale
    "activité culturelle africaine paris",
    "expérience danse africaine paris",
    "sortie culturelle africaine paris",
    "que faire paris danse africaine",
    "cours danse africaine paris pas cher",
  ],
  openGraph: {
    title: "Danse Zaouli à Paris — cours & spectacles | Dream Team Africa",
    description:
