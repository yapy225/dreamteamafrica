    ...
    <div className="min-h-screen bg-[#FAFAF7]">
      ...
      <nav className="border-b border-[#F0ECE7] bg-white">
        <div className="mx-auto flex max-w-7xl items-center gap-1.5 px-4 py-3 text-xs text-[#999] sm:px-6 lg:px-8">
          ...
          <Link href="/officiel-afrique" className="hover:text-[#C4704B] transition-colors">
          ...
          <aside className="space-y-6">
            ...
            <div>
              ...
              <div className="mt-2 space-y-1">
                <Link
                  href={`/officiel-afrique/annuaire${country ? `?country=${country}` : ""}${q ? `${country ? "&" : "?"}q=${q}` : ""}`}
                ...
                {categories.map((c) => (
                    <Link
                      key={c.category}
                      href={`/officiel-afrique/annuaire?category=${encodeURIComponent(c.category)}${country ? `&country=${country}` : ""}${q ? `&q=${q}` : ""}`}
            ...
            <div>
              ...
              <div className="mt-2 space-y-1">
                <Link
                  href={`/officiel-afrique/annuaire${category ? `?category=${category}` : ""}${q ? `${category ? "&" : "?"}q=${q}` : ""}`}
                ...
                {countries.map((c) => (
                  <Link
                    key={c.country}
                    href={`/officiel-afrique/annuaire?${category ? `category=${category}&` : ""}country=${encodeURIComponent(c.country!)}${q ? `&q=${q}` : ""}`}
            ...
            {/* CTA */}
            <Link
              href="/officiel-afrique#inscription"
