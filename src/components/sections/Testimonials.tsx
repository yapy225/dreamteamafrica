...
const testimonialsByEvent: Record<string, { label: string; items: Testimonial[] }> = {
  ...
  "juste-une-danse": {
    label: "Juste Une Danse \u2014 Festival de danse traditionnelle africaine",
    items: [
      {
        name: "Dylan Marchand",
        role: "Passionn\u00e9 de culture urbaine",
        title: "IShowSpeed m\u2019a donn\u00e9 envie, ce festival m\u2019a convaincu",
        text: "Je ne connaissais absolument pas la danse traditionnelle africaine. J\u2019ai suivi le voyage d\u2019IShowSpeed en Afrique et je l\u2019ai vu danser avec les locaux \u2014 le rythme, l\u2019\u00e9nergie, j\u2019ai trouv\u00e9 \u00e7a g\u00e9nial. Vivement ce festival pour d\u00e9couvrir tout \u00e7a en vrai \u00e0 Paris !",
        rating: 5,
      },
      {
        name: "Camille Lefort",
        role: "Curieuse culturelle",
        title: "Culture pour Tous m\u2019a permis de r\u00e9server sans h\u00e9siter",
        text: "Je suis une curieuse culturelle n\u00e9e, donc quand j\u2019ai vu qu\u2019on pouvait r\u00e9server avec seulement 5\u00a0\u20ac gr\u00e2ce \u00e0 Culture pour Tous et payer petit \u00e0 petit, je n\u2019ai pas h\u00e9sit\u00e9. J\u2019attends avec impatience de d\u00e9couvrir les danses traditionnelles !",
        rating: 5,
      },
      {
        name: "Rachid Benmoussa",
        role: "Amateur de danse",
        title: "Enfin un festival danse chez DTA !",
        text: "\u00c7a fait un moment que je suis les activit\u00e9s de cette association, et quand j\u2019ai vu qu\u2019ils organisaient un festival de danse traditionnelle africaine, c\u2019\u00e9tait le bingo pour moi. J\u2019adore la danse, j\u2019adore la culture africaine. Il me tarde d\u2019y \u00eatre !",
        rating: 5,
      },
    ],
  },
